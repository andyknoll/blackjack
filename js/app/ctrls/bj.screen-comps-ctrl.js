...
// getters
bj.ScreenCompsCtrl.prototype.screensComp = function() {
	return this.views().appComp.screensComp;
};

// splashComp
bj.ScreenCompsCtrl.prototype.splashScreenComp = function() {
	return this.screensComp().splashScreenComp;
};

bj.ScreenCompsCtrl.prototype.splashComp = function() {
	return this.splashScreenComp().splashComp;
};

// tableComp
bj.ScreenCompsCtrl.prototype.tableScreenComp = function() {
	return this.screensComp().tableScreenComp;
};

bj.ScreenCompsCtrl.prototype.tableComp = function() {
	return this.tableScreenComp().tableComp;
};

// anteComp
bj.ScreenCompsCtrl.prototype.anteScreenComp = function() {
	return this.screensComp().anteScreenComp;
};

bj.ScreenCompsCtrl.prototype.anteComp = function() {
	return this.anteScreenComp().anteComp;
};

// playComp
bj.ScreenCompsCtrl.prototype.playScreenComp = function() {
	return this.screensComp().playScreenComp;
};

bj.ScreenCompsCtrl.prototype.playComp = function() {
	return this.playScreenComp().playComp;
};

// debugComp
bj.ScreenCompsCtrl.prototype.debugScreenComp = function() {
	return this.screensComp().debugScreenComp;
};

bj.ScreenCompsCtrl.prototype.debugComp = function() {
	return this.debugScreenComp().debugComp;
};
...
bj.ScreenCompsCtrl.prototype.tableButtonPlayClickHandler = function() {
	alert("tableButtonPlayClickHandler");
};
...
bj.ScreenCompsCtrl.prototype.debugButton0ClickHandler = function() {
	alert("debugButton0ClickHandler");
};
